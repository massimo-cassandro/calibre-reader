...
<html lang="it">
  <head>
    ...
    <link rel="stylesheet" href="calibre-reader.css?_=0.6.5" type="text/css" media="all">
    <link rel="preload" href="calibre-reader-min.js?_=0.6.5" as="script">
  ...
  <body>
    ...
    <script src="calibre-reader-min.js?_=0.6.5"></script>
  </body>
</html>
