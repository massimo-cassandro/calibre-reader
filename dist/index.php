...
<html lang="it">
  <head>
    ...
    <link rel="stylesheet" href="calibre-reader.css?_=0.7.2" type="text/css" media="all">
    <link rel="preload" href="calibre-reader-min.js?_=0.7.2" as="script">
  ...
  <body>
    ...
    <script src="calibre-reader-min.js?_=0.7.2"></script>
  </body>
</html>
